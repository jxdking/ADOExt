...
namespace MagicEastern.ADOExt.Oracle
{
    public class DBTableAdapter<T> : DBTableAdapterBase<T> where T: new()
    {
        ...
        public static IDBTableAdapter<T> Get(IResolverProvider resolverProvider, ICommandBuilder<T> commandBuilder, DBConnectionWrapper currentConnection, DBTransactionWrapper currentTrans)
        {
